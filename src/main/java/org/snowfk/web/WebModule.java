...
public class WebModule {
    ...
    List<WebModelRef> getMatchWebModelRef(String fullPriPath) {
        ...
        for (WebModelRef webModelRef : webModelRefList) {
            //System.out.println("WebModule.getMatchWebModeulRef: " + webModelRef.toString());
    ...
    @Inject
    public void setWebBeans(@Nullable @WebHandlers List<Object> activeBeans) {
        this.webBeans = activeBeans;
    }
    ...
    public void init() throws Exception {
        for (Object activeBean : webBeans) {
    ...
    private final void registerWebHandlerMethods(Object targetObject) throws Exception {
        ...
        for (Method m : methods) {
            ...
            // if it is an action method, then, add the WebAction Object and Method to the action Dic
            if (action != null) {
    ...
    private final void registerWebModel(Object webHandler, Method m, WebModel webModel) {
        //System.out.println("Register WebModel " + getName() + " - " + m.getName());
    ...
    private final void registerWebAction(Object webHandler, Method m, WebAction webAction) throws Exception {
        ...
        if (actionRef != null) {
            //AlertHandler.systemSevere(Alert.ACTION_NAME_ALREADY_EXIST, actionName);
            throw new Exception("Action Name Already Exist: " + actionName);
        }
        // if not found, create an empty list
        //System.out.println("WebModule.registerWebAction: " + getName() + ":" + actionName);
    ...
    private final void registerWebTemplateDirective(Object webHandler, Method m, WebTemplateDirective webTemplateDirective)
                            throws Exception {
